...
const proyectsData = [
  ...
  },
  {
    ...
    description:
      'Crear una aplicación del tiempo que permita la visualización en tiempo real de la información meteorológica como la previsión de la misma a 5 días',
    origin: 'Proyecto Rock{theCode}',
    repo: 'Github',
    imgRepo:
      'https://res.cloudinary.com/dwsffp1eq/image/upload/v1683118881/Portfolio/github_ejpjmn.png',
    linkRepo: 'https://github.com/Graimi/proyecto-5-app-del-tiempo',
    linkdeploy: 'https://app-tiempo.netlify.app/',
    technologies: [
      {
        technology: 'HTML',
        img: 'https://res.cloudinary.com/dwsffp1eq/image/upload/v1683362632/logos/html_jhpxjv.png'
